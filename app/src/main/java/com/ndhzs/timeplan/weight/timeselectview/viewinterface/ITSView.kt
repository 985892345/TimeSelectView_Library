 ...
 */
interface ITSView {
    fun addBackCardView(lp: FrameLayout.LayoutParams, v: TimeSelectView)
    fun addTimeScrollView(lp: FrameLayout.LayoutParams, v: TimeSelectView)
    fun addRectImgView(lp: FrameLayout.LayoutParams, v: TimeSelectView)
    fun showNowTimeLine()
